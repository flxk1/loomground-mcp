...
def test_loomground_catalogue():
    ...
    assert r["source"] == {"repo": "https://github.com/flxk1/loomground", "commit": "ec5d8ecf57d63bef4b3a52efbc4100ea03c4b18d"}
...
def test_loomground_releases():
    ...
    assert r["source"] == {"repo": "https://github.com/flxk1/loomground", "commit": "ec5d8ecf57d63bef4b3a52efbc4100ea03c4b18d"}
    assert len(r["repos"]) == 42 and len(r["edges"]) == 67 and len(r["accepted"]) == 18 and r["skipped"] == ["RVND"]
